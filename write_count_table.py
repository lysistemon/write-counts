...
# Define metadata file and literals
ANNOFN = "./metadata/{LIMSID}_anno.tsv".format(LIMSID=LIMSID)
GTFFILE = "./ref/Homo_sapiens.GRCh37.dna.gencode.v26lift37.basic.with_ERCC.gff"
...
OUTFNFMT = "./data/processed/{limsid}.counts_celseq.tsv.gz"
...
# Load raw data files and store binned counts
countdata = list()
for irow, row in anno.iterrows():
    ...
    if not os.access(fn, os.R_OK):
        ...
        # this happens if tophat2 didn't run because the demultiplexed input FASTQ files were empty
